...
# PAGE PRÉVISION
    ...
    if submitted:
        with st.spinner("...Analyse en cours..."):
            ...
            #base_rendement = {predict_rendement(region, culture, type_sol, superficie, pluviometrie, temperature_moy)}
...
# PAGE VISUALISATIONS
    ...
    with tab1:
        ...
        st.info("Ces données sont basées sur les prévisions historiques du données simulées pour l'instant  .")
...
# PAGE À PROPOS
    ...
    with tab3:
        ...
        st.markdown("---")
        st.caption("© 2026 Système de Prévision Agricole IA - Togo| Groupe 1 - Mais  | Version 1.0")
...
with col_f3:
    st.caption("propulser par Streamlit ")
