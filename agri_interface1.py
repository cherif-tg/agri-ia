...
with st.sidebar:
    ...
    page = st.radio(
        ...
        ["🏠 Accueil", "📊 Prévision", "📈 Visualisations", "📚 Historique", "ℹ️ À propos"]
    )
...
# PAGE VISUALISATIONS
    ...
    tab1, tab2, tab3 = st.tabs(["📊 Tendances Régionales", "🌧️ Analyse Climatique", "📅 Calendrier Cultural"])
...
# PAGE À PROPOS
    ...
    with tab3:
        ...
        - 📧 Email : support@agri-ia-togo.org
